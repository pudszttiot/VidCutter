...
def update_status_label():
    for _ in range(10):  # Number of times to blink
        status_label.config(text="Cutting video in progress", fg="#CC1512", bg="#FFFFFF")
        window.update()
        time.sleep(0.5)
        status_label.config(text="Cutting video in progress", fg="#FBFFFF", bg="#CC1512")
        window.update()
        time.sleep(0.5)
...
def open_help_file():
    ...
    help_file_path = (
        "G:/Software/py/Python Creations/Completed/Projects/VideoCutter/Readme.txt"
    )
...
window.iconbitmap(r"G:\Software\py\Python Creations\Completed\Projects\VideoCutter\Images\video cut.ico")  # Set the path to your icon file
...
heading_label = tk.Label(
    window, text="Video Cutter", font=("THE BOLD FONT", 25), bg="#2A292B", fg="#FFF01F"
)
heading_label.pack()
